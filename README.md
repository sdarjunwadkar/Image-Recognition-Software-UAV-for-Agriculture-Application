# Image-Recognition-Software-UAV-for-Agriculture-Application


Development of Image recognition software to detect plant disease and estimate yield using an UAV to gather data.
...
```
https://github.com/sdarjunwadkar/Image-Recognition-Software-UAV-for-Agriculture-Application.git
cd Code

```
2. Install few required pip packages
